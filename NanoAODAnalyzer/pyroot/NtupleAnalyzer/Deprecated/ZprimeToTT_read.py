<<<<<<< Updated upstream:NanoAODAnalyzer/pyroot/NtupleAnalyzer/Deprecated/ZprimeToTT_read.py
import sys
import os
import glob
import ROOT
...
>>>>>>> Stashed changes:NanoAODAnalyzer/pyroot/NtupleAnalyzer/ZprimeToTT_read.py
